import{E as g,o as y}from"./VertexArrayObject-CLpjg57p.js";import{x as F,s as v}from"./FramebufferObject--4ZHTLY2.js";import{r as c}from"./ProgramTemplate-YrOnZ5NE.js";import{e as P,a as w}from"./ProgramTemplate-YrOnZ5NE.js";import{d5 as C}from"./index-jfgqsXUF.js";import{t as p}from"./NestedMap-CImDozOA.js";import"./memoryEstimations-BucWCUN2.js";import"./vendor-0HVaVRtn.js";class x{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function b(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
