import{E as g,o as y}from"./VertexArrayObject-Z0flarmS.js";import{x as F,s as v}from"./FramebufferObject-Bz5LLHQL.js";import{r as c}from"./ProgramTemplate-DjKpG1ZK.js";import{e as P,a as w}from"./ProgramTemplate-DjKpG1ZK.js";import{d5 as C}from"./index-B9tlkxep.js";import{t as p}from"./NestedMap-CImDozOA.js";import"./memoryEstimations-CfiaYUy-.js";import"./vendor-0HVaVRtn.js";class x{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function b(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
